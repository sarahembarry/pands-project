...
print("A matrix of the correlation between the numeric variables in the datset has been generated:\n")
...
print("\nA Virginica entry was selected, and its features were input into the K-nearest neighbour model. Here is the Iris species predicted by the model:")
knn_plant = {
    'sepal_length': 5.9,
    'sepal_width': 3.0 ,
    'petal_length': 5.1 ,
